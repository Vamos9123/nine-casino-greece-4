...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-31092994');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-31092994');}
...
var brandEl=document.querySelector('.rl-brand-31092994');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
